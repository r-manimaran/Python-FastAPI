...
from schemas import Department, Employee, EmployeeBase,EmployeeCreate

app = FastAPI()

###### Proj4 - Request Body with Post endpoint
...
async def create_employee(employee: EmployeeCreate)->Employee:
    id = Employees[-1]["id"] + 1
    new_employee = Employee(id=id, **employee.model_dump()).model_dump()
